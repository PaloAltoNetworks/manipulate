...
func init() {
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructOrderedPartitioner, apomockNewStructOrderedPartitioner)
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructRandomPartitioner, apomockNewStructRandomPartitioner)
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructTokenRing, apomockNewStructTokenRing)
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructMurmur3Partitioner, apomockNewStructMurmur3Partitioner)
...
const (
	ApomockStructOrderedPartitioner = 54
	ApomockStructRandomPartitioner  = 55
	ApomockStructTokenRing          = 56
	ApomockStructMurmur3Partitioner = 57
)
