...
func init() {
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructTypeParserResult, apomockNewStructTypeParserResult)
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructTypeParserClassNode, apomockNewStructTypeParserClassNode)
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructTypeParserParamNode, apomockNewStructTypeParserParamNode)
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructSchemaDescriber, apomockNewStructSchemaDescriber)
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructTypeParser, apomockNewStructTypeParser)
...
const (
	ApomockStructTypeParserResult    = 43
	ApomockStructTypeParserClassNode = 44
	ApomockStructTypeParserParamNode = 45
	ApomockStructSchemaDescriber     = 46
	ApomockStructTypeParser          = 47
)
