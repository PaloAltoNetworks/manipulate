...
func init() {
	...
	apomock.RegisterFunc("gocql", "gocql.unmarshalSmallInt", AuxMockunmarshalSmallInt)
	...
	apomock.RegisterFunc("gocql", "gocql.decShort", AuxMockdecShort)
	...
	apomock.RegisterFunc("gocql", "gocql.decTiny", AuxMockdecTiny)
	...
	apomock.RegisterFunc("gocql", "gocql.marshalSmallInt", AuxMockmarshalSmallInt)
	apomock.RegisterFunc("gocql", "gocql.unmarshalTinyInt", AuxMockunmarshalTinyInt)
	...
	apomock.RegisterFunc("gocql", "gocql.marshalTinyInt", AuxMockmarshalTinyInt)
	...
	apomock.RegisterFunc("gocql", "gocql.encShort", AuxMockencShort)
...
//
// Mock: unmarshalSmallInt(arginfo TypeInfo, argdata []byte, argvalue interface{})(reta error)
//

type MockArgsTypeunmarshalSmallInt struct {
	ApomockCallNumber int
	Arginfo           TypeInfo
	Argdata           []byte
	Argvalue          interface{}
...
var LastMockArgsunmarshalSmallInt MockArgsTypeunmarshalSmallInt

// AuxMockunmarshalSmallInt(arginfo TypeInfo, argdata []byte, argvalue interface{})(reta error) - Generated mock function
func AuxMockunmarshalSmallInt(arginfo TypeInfo, argdata []byte, argvalue interface{}) (reta error) {
	LastMockArgsunmarshalSmallInt = MockArgsTypeunmarshalSmallInt{
		ApomockCallNumber: AuxMockGetRecorderAuxMockunmarshalSmallInt(),
		Arginfo:           arginfo,
		Argdata:           argdata,
		Argvalue:          argvalue,
	}
	rargs, rerr := apomock.GetNext("gocql.unmarshalSmallInt")
	if rerr != nil {
		panic("Error getting next entry for method: gocql.unmarshalSmallInt")
	} else if rargs.NumArgs() != 1 {
		panic("All return parameters not provided for method:gocql.unmarshalSmallInt")
	}
	if rargs.GetArg(0) != nil {
		reta = rargs.GetArg(0).(error)
	}
...
// RecorderAuxMockunmarshalSmallInt  - Stats Recorder to keep a count on how many times the function has been called
var recorderAuxMockunmarshalSmallInt int = 0

var condRecorderAuxMockunmarshalSmallInt *sync.Cond = &sync.Cond{L: &sync.Mutex{}}

func AuxMockWaitForRecorderAuxMockunmarshalSmallInt(i int) {
	condRecorderAuxMockunmarshalSmallInt.L.Lock()
	for recorderAuxMockunmarshalSmallInt < i {
		condRecorderAuxMockunmarshalSmallInt.Wait()
	}
	condRecorderAuxMockunmarshalSmallInt.L.Unlock()
}

func AuxMockIncrementRecorderAuxMockunmarshalSmallInt() {
	condRecorderAuxMockunmarshalSmallInt.L.Lock()
	recorderAuxMockunmarshalSmallInt++
	condRecorderAuxMockunmarshalSmallInt.L.Unlock()
	condRecorderAuxMockunmarshalSmallInt.Broadcast()
}
func AuxMockGetRecorderAuxMockunmarshalSmallInt() (ret int) {
	condRecorderAuxMockunmarshalSmallInt.L.Lock()
	ret = recorderAuxMockunmarshalSmallInt
	condRecorderAuxMockunmarshalSmallInt.L.Unlock()
	return
}

// unmarshalSmallInt - Mocked version of actual API. Does Recordkeeping and calls the user provided mock or default mock
func unmarshalSmallInt(arginfo TypeInfo, argdata []byte, argvalue interface{}) (reta error) {
	FuncAuxMockunmarshalSmallInt, ok := apomock.GetRegisteredFunc("gocql.unmarshalSmallInt")
	if ok {
		reta = FuncAuxMockunmarshalSmallInt.(func(arginfo TypeInfo, argdata []byte, argvalue interface{}) (reta error))(arginfo, argdata, argvalue)
	} else {
		panic("FuncAuxMockunmarshalSmallInt ")
	}
	AuxMockIncrementRecorderAuxMockunmarshalSmallInt()
	return
}
...
//
// Mock: decShort(argp []byte)(reta int16)
//

type MockArgsTypedecShort struct {
	ApomockCallNumber int
	Argp              []byte
}

var LastMockArgsdecShort MockArgsTypedecShort

// AuxMockdecShort(argp []byte)(reta int16) - Generated mock function
func AuxMockdecShort(argp []byte) (reta int16) {
	LastMockArgsdecShort = MockArgsTypedecShort{
		ApomockCallNumber: AuxMockGetRecorderAuxMockdecShort(),
		Argp:              argp,
	}
	rargs, rerr := apomock.GetNext("gocql.decShort")
	if rerr != nil {
		panic("Error getting next entry for method: gocql.decShort")
	} else if rargs.NumArgs() != 1 {
		panic("All return parameters not provided for method:gocql.decShort")
	}
	if rargs.GetArg(0) != nil {
		reta = rargs.GetArg(0).(int16)
	}
	return
}

// RecorderAuxMockdecShort  - Stats Recorder to keep a count on how many times the function has been called
var recorderAuxMockdecShort int = 0

var condRecorderAuxMockdecShort *sync.Cond = &sync.Cond{L: &sync.Mutex{}}

func AuxMockWaitForRecorderAuxMockdecShort(i int) {
	condRecorderAuxMockdecShort.L.Lock()
	for recorderAuxMockdecShort < i {
		condRecorderAuxMockdecShort.Wait()
	}
	condRecorderAuxMockdecShort.L.Unlock()
}

func AuxMockIncrementRecorderAuxMockdecShort() {
	condRecorderAuxMockdecShort.L.Lock()
	recorderAuxMockdecShort++
	condRecorderAuxMockdecShort.L.Unlock()
	condRecorderAuxMockdecShort.Broadcast()
}
func AuxMockGetRecorderAuxMockdecShort() (ret int) {
	condRecorderAuxMockdecShort.L.Lock()
	ret = recorderAuxMockdecShort
	condRecorderAuxMockdecShort.L.Unlock()
	return
}

// decShort - Mocked version of actual API. Does Recordkeeping and calls the user provided mock or default mock
func decShort(argp []byte) (reta int16) {
	FuncAuxMockdecShort, ok := apomock.GetRegisteredFunc("gocql.decShort")
	if ok {
		reta = FuncAuxMockdecShort.(func(argp []byte) (reta int16))(argp)
	} else {
		panic("FuncAuxMockdecShort ")
	}
	AuxMockIncrementRecorderAuxMockdecShort()
	return
}
...
//
// Mock: decTiny(argp []byte)(reta int8)
//

type MockArgsTypedecTiny struct {
	ApomockCallNumber int
	Argp              []byte
}

var LastMockArgsdecTiny MockArgsTypedecTiny

// AuxMockdecTiny(argp []byte)(reta int8) - Generated mock function
func AuxMockdecTiny(argp []byte) (reta int8) {
	LastMockArgsdecTiny = MockArgsTypedecTiny{
		ApomockCallNumber: AuxMockGetRecorderAuxMockdecTiny(),
		Argp:              argp,
	}
	rargs, rerr := apomock.GetNext("gocql.decTiny")
	if rerr != nil {
		panic("Error getting next entry for method: gocql.decTiny")
	} else if rargs.NumArgs() != 1 {
		panic("All return parameters not provided for method:gocql.decTiny")
	}
	if rargs.GetArg(0) != nil {
		reta = rargs.GetArg(0).(int8)
	}
	return
}

// RecorderAuxMockdecTiny  - Stats Recorder to keep a count on how many times the function has been called
var recorderAuxMockdecTiny int = 0

var condRecorderAuxMockdecTiny *sync.Cond = &sync.Cond{L: &sync.Mutex{}}

func AuxMockWaitForRecorderAuxMockdecTiny(i int) {
	condRecorderAuxMockdecTiny.L.Lock()
	for recorderAuxMockdecTiny < i {
		condRecorderAuxMockdecTiny.Wait()
	}
	condRecorderAuxMockdecTiny.L.Unlock()
}

func AuxMockIncrementRecorderAuxMockdecTiny() {
	condRecorderAuxMockdecTiny.L.Lock()
	recorderAuxMockdecTiny++
	condRecorderAuxMockdecTiny.L.Unlock()
	condRecorderAuxMockdecTiny.Broadcast()
}
func AuxMockGetRecorderAuxMockdecTiny() (ret int) {
	condRecorderAuxMockdecTiny.L.Lock()
	ret = recorderAuxMockdecTiny
	condRecorderAuxMockdecTiny.L.Unlock()
	return
}

// decTiny - Mocked version of actual API. Does Recordkeeping and calls the user provided mock or default mock
func decTiny(argp []byte) (reta int8) {
	FuncAuxMockdecTiny, ok := apomock.GetRegisteredFunc("gocql.decTiny")
	if ok {
		reta = FuncAuxMockdecTiny.(func(argp []byte) (reta int8))(argp)
	} else {
		panic("FuncAuxMockdecTiny ")
	}
	AuxMockIncrementRecorderAuxMockdecTiny()
	return
}
...
//
// Mock: marshalSmallInt(arginfo TypeInfo, argvalue interface{})(reta []byte, retb error)
//

type MockArgsTypemarshalSmallInt struct {
	ApomockCallNumber int
	Arginfo           TypeInfo
	Argvalue          interface{}
}

var LastMockArgsmarshalSmallInt MockArgsTypemarshalSmallInt

// AuxMockmarshalSmallInt(arginfo TypeInfo, argvalue interface{})(reta []byte, retb error) - Generated mock function
func AuxMockmarshalSmallInt(arginfo TypeInfo, argvalue interface{}) (reta []byte, retb error) {
	LastMockArgsmarshalSmallInt = MockArgsTypemarshalSmallInt{
		ApomockCallNumber: AuxMockGetRecorderAuxMockmarshalSmallInt(),
		Arginfo:           arginfo,
		Argvalue:          argvalue,
	}
	rargs, rerr := apomock.GetNext("gocql.marshalSmallInt")
	if rerr != nil {
		panic("Error getting next entry for method: gocql.marshalSmallInt")
	} else if rargs.NumArgs() != 2 {
		panic("All return parameters not provided for method:gocql.marshalSmallInt")
	}
	if rargs.GetArg(0) != nil {
		reta = rargs.GetArg(0).([]byte)
	}
...
// RecorderAuxMockmarshalSmallInt  - Stats Recorder to keep a count on how many times the function has been called
var recorderAuxMockmarshalSmallInt int = 0

var condRecorderAuxMockmarshalSmallInt *sync.Cond = &sync.Cond{L: &sync.Mutex{}}

func AuxMockWaitForRecorderAuxMockmarshalSmallInt(i int) {
	condRecorderAuxMockmarshalSmallInt.L.Lock()
	for recorderAuxMockmarshalSmallInt < i {
		condRecorderAuxMockmarshalSmallInt.Wait()
	}
	condRecorderAuxMockmarshalSmallInt.L.Unlock()
}

func AuxMockIncrementRecorderAuxMockmarshalSmallInt() {
	condRecorderAuxMockmarshalSmallInt.L.Lock()
	recorderAuxMockmarshalSmallInt++
	condRecorderAuxMockmarshalSmallInt.L.Unlock()
	condRecorderAuxMockmarshalSmallInt.Broadcast()
}
func AuxMockGetRecorderAuxMockmarshalSmallInt() (ret int) {
	condRecorderAuxMockmarshalSmallInt.L.Lock()
	ret = recorderAuxMockmarshalSmallInt
	condRecorderAuxMockmarshalSmallInt.L.Unlock()
	return
}

// marshalSmallInt - Mocked version of actual API. Does Recordkeeping and calls the user provided mock or default mock
func marshalSmallInt(arginfo TypeInfo, argvalue interface{}) (reta []byte, retb error) {
	FuncAuxMockmarshalSmallInt, ok := apomock.GetRegisteredFunc("gocql.marshalSmallInt")
	if ok {
		reta, retb = FuncAuxMockmarshalSmallInt.(func(arginfo TypeInfo, argvalue interface{}) (reta []byte, retb error))(arginfo, argvalue)
	} else {
		panic("FuncAuxMockmarshalSmallInt ")
	}
	AuxMockIncrementRecorderAuxMockmarshalSmallInt()
	return
}

//
// Mock: unmarshalTinyInt(arginfo TypeInfo, argdata []byte, argvalue interface{})(reta error)
//

type MockArgsTypeunmarshalTinyInt struct {
	ApomockCallNumber int
	Arginfo           TypeInfo
	Argdata           []byte
	Argvalue          interface{}
...
var LastMockArgsunmarshalTinyInt MockArgsTypeunmarshalTinyInt

// AuxMockunmarshalTinyInt(arginfo TypeInfo, argdata []byte, argvalue interface{})(reta error) - Generated mock function
func AuxMockunmarshalTinyInt(arginfo TypeInfo, argdata []byte, argvalue interface{}) (reta error) {
	LastMockArgsunmarshalTinyInt = MockArgsTypeunmarshalTinyInt{
		ApomockCallNumber: AuxMockGetRecorderAuxMockunmarshalTinyInt(),
		Arginfo:           arginfo,
		Argdata:           argdata,
		Argvalue:          argvalue,
	}
	rargs, rerr := apomock.GetNext("gocql.unmarshalTinyInt")
	if rerr != nil {
		panic("Error getting next entry for method: gocql.unmarshalTinyInt")
	} else if rargs.NumArgs() != 1 {
		panic("All return parameters not provided for method:gocql.unmarshalTinyInt")
	}
	if rargs.GetArg(0) != nil {
		reta = rargs.GetArg(0).(error)
	}
...
// RecorderAuxMockunmarshalTinyInt  - Stats Recorder to keep a count on how many times the function has been called
var recorderAuxMockunmarshalTinyInt int = 0

var condRecorderAuxMockunmarshalTinyInt *sync.Cond = &sync.Cond{L: &sync.Mutex{}}

func AuxMockWaitForRecorderAuxMockunmarshalTinyInt(i int) {
	condRecorderAuxMockunmarshalTinyInt.L.Lock()
	for recorderAuxMockunmarshalTinyInt < i {
		condRecorderAuxMockunmarshalTinyInt.Wait()
	}
	condRecorderAuxMockunmarshalTinyInt.L.Unlock()
}

func AuxMockIncrementRecorderAuxMockunmarshalTinyInt() {
	condRecorderAuxMockunmarshalTinyInt.L.Lock()
	recorderAuxMockunmarshalTinyInt++
	condRecorderAuxMockunmarshalTinyInt.L.Unlock()
	condRecorderAuxMockunmarshalTinyInt.Broadcast()
}
func AuxMockGetRecorderAuxMockunmarshalTinyInt() (ret int) {
	condRecorderAuxMockunmarshalTinyInt.L.Lock()
	ret = recorderAuxMockunmarshalTinyInt
	condRecorderAuxMockunmarshalTinyInt.L.Unlock()
	return
}

// unmarshalTinyInt - Mocked version of actual API. Does Recordkeeping and calls the user provided mock or default mock
func unmarshalTinyInt(arginfo TypeInfo, argdata []byte, argvalue interface{}) (reta error) {
	FuncAuxMockunmarshalTinyInt, ok := apomock.GetRegisteredFunc("gocql.unmarshalTinyInt")
	if ok {
		reta = FuncAuxMockunmarshalTinyInt.(func(arginfo TypeInfo, argdata []byte, argvalue interface{}) (reta error))(arginfo, argdata, argvalue)
	} else {
		panic("FuncAuxMockunmarshalTinyInt ")
	}
	AuxMockIncrementRecorderAuxMockunmarshalTinyInt()
	return
}
...
//
// Mock: marshalTinyInt(arginfo TypeInfo, argvalue interface{})(reta []byte, retb error)
//

type MockArgsTypemarshalTinyInt struct {
	ApomockCallNumber int
	Arginfo           TypeInfo
	Argvalue          interface{}
}

var LastMockArgsmarshalTinyInt MockArgsTypemarshalTinyInt

// AuxMockmarshalTinyInt(arginfo TypeInfo, argvalue interface{})(reta []byte, retb error) - Generated mock function
func AuxMockmarshalTinyInt(arginfo TypeInfo, argvalue interface{}) (reta []byte, retb error) {
	LastMockArgsmarshalTinyInt = MockArgsTypemarshalTinyInt{
		ApomockCallNumber: AuxMockGetRecorderAuxMockmarshalTinyInt(),
		Arginfo:           arginfo,
		Argvalue:          argvalue,
	}
	rargs, rerr := apomock.GetNext("gocql.marshalTinyInt")
	if rerr != nil {
		panic("Error getting next entry for method: gocql.marshalTinyInt")
	} else if rargs.NumArgs() != 2 {
		panic("All return parameters not provided for method:gocql.marshalTinyInt")
	}
	if rargs.GetArg(0) != nil {
		reta = rargs.GetArg(0).([]byte)
	}
...
// RecorderAuxMockmarshalTinyInt  - Stats Recorder to keep a count on how many times the function has been called
var recorderAuxMockmarshalTinyInt int = 0

var condRecorderAuxMockmarshalTinyInt *sync.Cond = &sync.Cond{L: &sync.Mutex{}}

func AuxMockWaitForRecorderAuxMockmarshalTinyInt(i int) {
	condRecorderAuxMockmarshalTinyInt.L.Lock()
	for recorderAuxMockmarshalTinyInt < i {
		condRecorderAuxMockmarshalTinyInt.Wait()
	}
	condRecorderAuxMockmarshalTinyInt.L.Unlock()
}

func AuxMockIncrementRecorderAuxMockmarshalTinyInt() {
	condRecorderAuxMockmarshalTinyInt.L.Lock()
	recorderAuxMockmarshalTinyInt++
	condRecorderAuxMockmarshalTinyInt.L.Unlock()
	condRecorderAuxMockmarshalTinyInt.Broadcast()
}
func AuxMockGetRecorderAuxMockmarshalTinyInt() (ret int) {
	condRecorderAuxMockmarshalTinyInt.L.Lock()
	ret = recorderAuxMockmarshalTinyInt
	condRecorderAuxMockmarshalTinyInt.L.Unlock()
	return
}

// marshalTinyInt - Mocked version of actual API. Does Recordkeeping and calls the user provided mock or default mock
func marshalTinyInt(arginfo TypeInfo, argvalue interface{}) (reta []byte, retb error) {
	FuncAuxMockmarshalTinyInt, ok := apomock.GetRegisteredFunc("gocql.marshalTinyInt")
	if ok {
		reta, retb = FuncAuxMockmarshalTinyInt.(func(arginfo TypeInfo, argvalue interface{}) (reta []byte, retb error))(arginfo, argvalue)
	} else {
		panic("FuncAuxMockmarshalTinyInt ")
	}
	AuxMockIncrementRecorderAuxMockmarshalTinyInt()
	return
}
...
//
// Mock: encShort(argx int16)(reta []byte)
//

type MockArgsTypeencShort struct {
	ApomockCallNumber int
	Argx              int16
}

var LastMockArgsencShort MockArgsTypeencShort

// AuxMockencShort(argx int16)(reta []byte) - Generated mock function
func AuxMockencShort(argx int16) (reta []byte) {
	LastMockArgsencShort = MockArgsTypeencShort{
		ApomockCallNumber: AuxMockGetRecorderAuxMockencShort(),
		Argx:              argx,
	}
	rargs, rerr := apomock.GetNext("gocql.encShort")
	if rerr != nil {
		panic("Error getting next entry for method: gocql.encShort")
	} else if rargs.NumArgs() != 1 {
		panic("All return parameters not provided for method:gocql.encShort")
	}
	if rargs.GetArg(0) != nil {
		reta = rargs.GetArg(0).([]byte)
	}
...
// RecorderAuxMockencShort  - Stats Recorder to keep a count on how many times the function has been called
var recorderAuxMockencShort int = 0

var condRecorderAuxMockencShort *sync.Cond = &sync.Cond{L: &sync.Mutex{}}

func AuxMockWaitForRecorderAuxMockencShort(i int) {
	condRecorderAuxMockencShort.L.Lock()
	for recorderAuxMockencShort < i {
		condRecorderAuxMockencShort.Wait()
	}
	condRecorderAuxMockencShort.L.Unlock()
}

func AuxMockIncrementRecorderAuxMockencShort() {
	condRecorderAuxMockencShort.L.Lock()
	recorderAuxMockencShort++
	condRecorderAuxMockencShort.L.Unlock()
	condRecorderAuxMockencShort.Broadcast()
}
func AuxMockGetRecorderAuxMockencShort() (ret int) {
	condRecorderAuxMockencShort.L.Lock()
	ret = recorderAuxMockencShort
	condRecorderAuxMockencShort.L.Unlock()
	return
}

// encShort - Mocked version of actual API. Does Recordkeeping and calls the user provided mock or default mock
func encShort(argx int16) (reta []byte) {
	FuncAuxMockencShort, ok := apomock.GetRegisteredFunc("gocql.encShort")
	if ok {
		reta = FuncAuxMockencShort.(func(argx int16) (reta []byte))(argx)
	} else {
		panic("FuncAuxMockencShort ")
	}
	AuxMockIncrementRecorderAuxMockencShort()
	return
}
