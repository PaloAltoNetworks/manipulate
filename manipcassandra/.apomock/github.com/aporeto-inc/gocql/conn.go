...
import "github.com/aporeto-inc/gocql/apointernal/streams"
...
func init() {
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructPreparedStatment, apomockNewStructPreparedStatment)
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructInflightPrepare, apomockNewStructInflightPrepare)
	apomock.RegisterInternalType("github.com/aporeto-inc/gocql", ApomockStructCallReq, apomockNewStructCallReq)
...
const (
	ApomockStructPreparedStatment = 39
	ApomockStructInflightPrepare  = 40
	ApomockStructCallReq          = 41
)
