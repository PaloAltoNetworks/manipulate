...
func init() {
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructTokenAwareHostPolicy, apomockNewStructTokenAwareHostPolicy)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructRoundRobinHostPolicy, apomockNewStructRoundRobinHostPolicy)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructHostPoolHostPolicy, apomockNewStructHostPoolHostPolicy)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructSelectedHostPoolHost, apomockNewStructSelectedHostPoolHost)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructCowHostList, apomockNewStructCowHostList)
...
const (
	ApomockStructTokenAwareHostPolicy = 2
	ApomockStructRoundRobinHostPolicy = 3
	ApomockStructHostPoolHostPolicy   = 4
	ApomockStructSelectedHostPoolHost = 5
	ApomockStructCowHostList          = 6
)
