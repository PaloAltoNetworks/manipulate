...
func init() {
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructRing, apomockNewStructRing)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructClusterMetadata, apomockNewStructClusterMetadata)
