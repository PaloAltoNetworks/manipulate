...
func init() {
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructCassVersion, apomockNewStructCassVersion)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructRingDescriber, apomockNewStructRingDescriber)
...
const (
	ApomockStructCassVersion   = 0
	ApomockStructRingDescriber = 1
)
