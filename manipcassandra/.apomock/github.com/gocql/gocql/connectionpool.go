...
func init() {
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructHostConnPool, apomockNewStructHostConnPool)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructPolicyConnPool, apomockNewStructPolicyConnPool)
...
const (
	ApomockStructHostConnPool   = 44
	ApomockStructPolicyConnPool = 45
)
