...
func init() {
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructFramer, apomockNewStructFramer)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructSchemaChangeKeyspace, apomockNewStructSchemaChangeKeyspace)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructQueryValues, apomockNewStructQueryValues)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructReadyFrame, apomockNewStructReadyFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructResultVoidFrame, apomockNewStructResultVoidFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructAuthChallengeFrame, apomockNewStructAuthChallengeFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructWriteExecuteFrame, apomockNewStructWriteExecuteFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructWriteBatchFrame, apomockNewStructWriteBatchFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructWriteQueryFrame, apomockNewStructWriteQueryFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructFrameHeader, apomockNewStructFrameHeader)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructResultRowsFrame, apomockNewStructResultRowsFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructResultKeyspaceFrame, apomockNewStructResultKeyspaceFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructAuthenticateFrame, apomockNewStructAuthenticateFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructAuthSuccessFrame, apomockNewStructAuthSuccessFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructTopologyChangeEventFrame, apomockNewStructTopologyChangeEventFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructWriteAuthResponseFrame, apomockNewStructWriteAuthResponseFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructBatchStatment, apomockNewStructBatchStatment)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructWriteRegisterFrame, apomockNewStructWriteRegisterFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructResultMetadata, apomockNewStructResultMetadata)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructSchemaChangeTable, apomockNewStructSchemaChangeTable)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructQueryParams, apomockNewStructQueryParams)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructWriteStartupFrame, apomockNewStructWriteStartupFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructPreparedMetadata, apomockNewStructPreparedMetadata)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructSchemaChangeFunction, apomockNewStructSchemaChangeFunction)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructWriteOptionsFrame, apomockNewStructWriteOptionsFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructStatusChangeEventFrame, apomockNewStructStatusChangeEventFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructSupportedFrame, apomockNewStructSupportedFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructWritePrepareFrame, apomockNewStructWritePrepareFrame)
	apomock.RegisterInternalType("github.com/gocql/gocql", ApomockStructResultPreparedFrame, apomockNewStructResultPreparedFrame)
...
const (
	ApomockStructFramer                   = 15
	ApomockStructSchemaChangeKeyspace     = 16
	ApomockStructQueryValues              = 17
	ApomockStructReadyFrame               = 18
	ApomockStructResultVoidFrame          = 19
	ApomockStructAuthChallengeFrame       = 20
	ApomockStructWriteExecuteFrame        = 21
	ApomockStructWriteBatchFrame          = 22
	ApomockStructWriteQueryFrame          = 23
	ApomockStructFrameHeader              = 24
	ApomockStructResultRowsFrame          = 25
	ApomockStructResultKeyspaceFrame      = 26
	ApomockStructAuthenticateFrame        = 27
	ApomockStructAuthSuccessFrame         = 28
	ApomockStructTopologyChangeEventFrame = 29
	ApomockStructWriteAuthResponseFrame   = 30
	ApomockStructBatchStatment            = 31
	ApomockStructWriteRegisterFrame       = 32
	ApomockStructResultMetadata           = 33
	ApomockStructSchemaChangeTable        = 34
	ApomockStructQueryParams              = 35
	ApomockStructWriteStartupFrame        = 36
	ApomockStructPreparedMetadata         = 37
	ApomockStructSchemaChangeFunction     = 38
	ApomockStructWriteOptionsFrame        = 39
	ApomockStructStatusChangeEventFrame   = 40
	ApomockStructSupportedFrame           = 41
	ApomockStructWritePrepareFrame        = 42
	ApomockStructResultPreparedFrame      = 43
)
