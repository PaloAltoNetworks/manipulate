...
func TestHTTP_send(t *testing.T) {
	...
	Convey("Given I have a server returning 408 and a retry func", t, func() {
	...
	Convey("Given I have a server returning 408 and a retry func that returns a error at try 3", t, func() {
